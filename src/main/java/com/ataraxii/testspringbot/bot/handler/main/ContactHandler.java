...
import com.ataraxii.testspringbot.bot.events.BookingCreatedEvent;
...
import com.ataraxii.testspringbot.bot.utils.BookingIdGenerator;
import com.ataraxii.testspringbot.bot.utils.UpdateExtractor;
...
public class ContactHandler implements StepHandler<Update> {
    ...
    public SendMessage handle(Long chatId, Update update) {
        ...
        log.info("Публикуем BookingCreatedEvent для админ-группы {}", settingsService.getAdminGroupChatId());
        eventPublisher.publishEvent(new BookingCreatedEvent(this, data, settingsService.getAdminGroupChatId()));
